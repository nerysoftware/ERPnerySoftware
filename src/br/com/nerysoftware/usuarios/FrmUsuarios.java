...
import br.com.nerysoftware.financeiro.ContasReceber;
...
import br.com.nerysoftware.principal.barra;
...
public class FrmUsuarios extends javax.swing.JInternalFrame {
    ...
    public FrmUsuarios() {
        initComponents();
        tabelaUsuarios.getTableHeader().setDefaultRenderer(new br.com.nerysoftware.principal.EstiloTabelaHeader());
        tabelaUsuarios.setDefaultRenderer(Object.class, new br.com.nerysoftware.principal.EstiloTabelaRenderer());
...
void selecionarLinha(String id) {
    ...
    private void initComponents() {
        ...
        if (tabelaUsuarios.getColumnModel().getColumnCount() > 0) {
            ...
            tabelaUsuarios.getColumnModel().getColumn(6).setResizable(false);
            tabelaUsuarios.getColumnModel().getColumn(7).setResizable(false);
        }
        ...
        jLabel4.setText("UF:");
        jPanel5.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 40, -1, -1));
    ...
    private void registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registrarActionPerformed
        ...
        if (selecionarRegistro) {
            ...
            if (codigo.getText().equals("") || nome.getText().equals("") || sexo.getSelectedItem().equals("SEXO")
                ...
                br.com.nerysoftware.usuarios.Usuarios us = new Usuarios();
