...
import br.com.nerysoftware.usuarios.UsuariosSql;
...
public class UserNfe extends javax.swing.JInternalFrame {
    ...
    public UserNfe() {
        initComponents();
        tabelaUser.getTableHeader().setDefaultRenderer(new br.com.nerysoftware.principal.EstiloTabelaHeader());
        tabelaUser.setDefaultRenderer(Object.class, new br.com.nerysoftware.principal.EstiloTabelaRenderer());
