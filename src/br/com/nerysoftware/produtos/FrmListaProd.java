...
public class FrmListaProd extends javax.swing.JInternalFrame {
    ...
    public void calcular() {
        ...
        for (int i = 0; i < br.com.nerysoftware.vendas.FrmCaixa.tabela.getRowCount(); i++) {
            pre = br.com.nerysoftware.vendas.FrmCaixa.tabela.getValueAt(i, 3).toString();
            quan = br.com.nerysoftware.vendas.FrmCaixa.tabela.getValueAt(i, 4).toString();
            preco = Double.parseDouble(pre);
            quantidade = Integer.parseInt(quan);
            calc = preco * quantidade;
            total = total + calc;
            br.com.nerysoftware.vendas.FrmCaixa.tabela.setValueAt(Math.rint(calc * 100) / 100, i, 5);

        }
      br.com.nerysoftware.vendas.FrmCaixa.total.setText("" + Math.rint(total * 100) / 100);
    ...
    private void initComponents() {
        ...
        tabelaProdutos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CÓDIGO", "CÓDIGO DE BARRA", "NOME PRODUTO", "VALOR"
            }
        ) {
    ...
    private void enviarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_enviarActionPerformed
        if (tabelaProdutos.getRowCount() > 0) {
            try {
                String quant = null;
                DefaultTableModel tabeladet = (DefaultTableModel) br.com.nerysoftware.vendas.FrmCaixa.tabela.getModel();
                ...
                if (linha == -1) {
                    ...
                    if ((quant.equals("")) || (quant.equals("0"))) {
                       JOptionPane.showMessageDialog(this, "Insira um valor maior que 0");
                        ...
                        for (int i = 0; i < br.com.nerysoftware.vendas.FrmCaixa.tabela.getRowCount(); i++) {
                            Object com = br.com.nerysoftware.vendas.FrmCaixa.tabela.getValueAt(i, 0);
                            Object quant1 = br.com.nerysoftware.vendas.FrmCaixa.tabela.getValueAt(i, 4);
                            if (cod.equals(com)) {
                                j = i;
                                int quantT = Integer.parseInt(quant) + Integer.parseInt((String) quant1);
                                br.com.nerysoftware.vendas.FrmCaixa.tabela.setValueAt(String.valueOf(quantT), i, 4);
                                c++;
                                calcular();
                                br.com.nerysoftware.vendas.FrmCaixa.recebido.setText("0.00");
                                br.com.nerysoftware.vendas.FrmCaixa.troco.setText("0.00");
                            }
                        }
                        if (c == 0) {
                            ...
                            br.com.nerysoftware.vendas.FrmCaixa.tabela.setModel(tabeladet);
                            calcular();
