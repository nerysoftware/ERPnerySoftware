...
public class TipoProduto extends javax.swing.JInternalFrame {
    ...
    public TipoProduto() {
        initComponents();
        TabelaTipo.getTableHeader().setDefaultRenderer(new br.com.nerysoftware.principal.EstiloTabelaHeader());
        TabelaTipo.setDefaultRenderer(Object.class, new br.com.nerysoftware.principal.EstiloTabelaRenderer());
