...
import br.com.nerysoftware.principal.MenuPrincipal;
import br.com.nerysoftware.usuarios.PermicaoUser;
import static br.com.nerysoftware.vendas.FrmCaixa.total;
...
public class FrmProdutos extends javax.swing.JInternalFrame {
    ...
    public FrmProdutos() {
        initComponents();
        tabelaProdutos.getTableHeader().setDefaultRenderer(new br.com.nerysoftware.principal.EstiloTabelaHeader());
        tabelaProdutos.setDefaultRenderer(Object.class, new br.com.nerysoftware.principal.EstiloTabelaRenderer());
    ...
    public void margem(){
     ...
     vtotal= Double.parseDouble(valorcompra.getText().replaceAll(",", "."));
     margem = Double.parseDouble(porcentagem.getText().replaceAll(",", "."));
    ...
    private void initComponents() {
        ...
        tabelaProdutos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "CÓDIGO", "CÓDIGO DE BARRA", "NOME DO PRODUTO", "ESTOQUE", "PREÇO DE CUSTO", "MARGEM DE LUCRO", "PREÇO DE VENDA"
            }
        ) {
        ...
        jPanel1.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(12, 326, 950, 210));
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 190, 660, 140));
        ...
        jPanel1.add(jPanel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(670, 190, 290, 110));
        ...
        jPanel2.add(tipo, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 110, 140, -1));
        ...
        jPanel2.add(deletar, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 80, 60, 100));
        ...
        jPanel2.add(un, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 110, 140, -1));
        ...
        jPanel2.add(deletar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 80, 60, 100));

        jLabel6.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel6.setText("TIPO DE PRODUTO");
        jPanel2.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 90, -1, -1));

        jLabel7.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        jLabel7.setText("UNIDADE DE MEDIDA");
        jPanel2.add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 90, -1, -1));
        ...
        jPanel2.add(ean, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 100, 220, 30));
        ...
        jPanel5Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(txtNcm, javax.swing.GroupLayout.PREFERRED_SIZE, 110, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(NCM))
                        .addGap(27, 27, 27)
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel1.add(jTabbedPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 950, 190));
    ...
    private void registrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registrarActionPerformed
        ...
        if (selecionarRegistro) {
            ...
            if (codigo.getText().equals("") || nome.getText().equals("") || tipo.getSelectedItem().equals("TIPO PRODUTO")
                ...
                br.com.nerysoftware.produtos.Produtos us = new Produtos();
     ...
     if (tabelaProdutos.getRowCount() > 0) {
            if (tabelaProdutos.getSelectedRowCount() > 0) {
                ...
                if (codigo.getText().equals("") || nome.getText().equals("") 
                    ...
                    us.setTipo(tipo.getSelectedItem().toString());
                    us.setNome(nome.getText()); 
                    us.setQuant_pro(estoque.getText().replaceAll(",", ".")); 
                    us.setValorcompra(valorcompra.getText().replaceAll(",", "."));
                    us.setMargem_lucro(porcentagem.getText().replaceAll(",", "."));
                    us.setValor(valorvenda.getText().replaceAll(",", "."));
                    us.setEan(ean.getText());
