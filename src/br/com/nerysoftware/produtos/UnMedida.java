...
public class UnMedida extends javax.swing.JInternalFrame {
    ...
    public UnMedida() {
        initComponents();
        TabelaUn.getTableHeader().setDefaultRenderer(new br.com.nerysoftware.principal.EstiloTabelaHeader());
        TabelaUn.setDefaultRenderer(Object.class, new br.com.nerysoftware.principal.EstiloTabelaRenderer());
