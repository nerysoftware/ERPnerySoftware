...
public class barra extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Progresso.setBackground(new java.awt.Color(255, 255, 204));
        Progresso.setToolTipText("ENVIANDO");
        Progresso.setAutoscrolls(true);
        Progresso.setDoubleBuffered(true);
        Progresso.setFocusCycleRoot(true);
        ...
        Progresso.getAccessibleContext().setAccessibleName("ENVIANDO");
