...
import br.com.nerysoftware.usuarios.LogBEAN;
import br.com.nerysoftware.usuarios.LogDAO;
   ...
   public void play(String nomeDoAudio){
    ...
    public Login(SplashScreen inicio){
        ...
        setProgress(100,"Bem vindo ao sistema!!");
          ...
          System.out.println("[Login - SplashScreen inicio]");
    }
                    ...
                    if (dado.equals("ADMINISTRADOR")){
                        ...
                        ResultSet rs3 = st3.executeQuery(sql3);
                         ...
                         dispose();
                          ...
                          System.out.println("[Login - Logar (Usuario Logado)]");
...
//                          menu.userConect.setText(dado);
                     ...
                     System.out.println("[Login - Logar (Senha Incorreta!)]");
                }
                
            }else{
                JOptionPane.showMessageDialog(this, "O usuário não existe no banco de dados!", "Login", 0);
                    System.out.println("[Login - Logar (O usuário não existe no banco de dados!)]");
            }
    ...
    private void initComponents() {
        ...
        painelImgCab.setBackground(new java.awt.Color(63, 47, 135));
        ...
        Txt_data.setFont(new java.awt.Font("Comic Sans MS", 1, 11)); // NOI18N
        Txt_data.setForeground(new java.awt.Color(255, 255, 255));
        Txt_data.setText("data");
        painelImgCab.add(Txt_data, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 40, 190, 20));

        Txt_hora.setFont(new java.awt.Font("Comic Sans MS", 1, 11)); // NOI18N
        Txt_hora.setForeground(new java.awt.Color(255, 255, 255));
        Txt_hora.setText("hora");
        painelImgCab.add(Txt_hora, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 10, 190, 20));
        ...
        painelImgCab.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 230, -1, 194));
        ...
        painelImgCab.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, -10, -1, 570));
